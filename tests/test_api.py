...
def test_api_get_route_schedules(ridesystems_api):
    """Test for Ridesystems API method get_route_schedules"""
...
def test_api_get_route_schedule_times(ridesystems_api):
    """Test for Ridesystems API method get_route_schedule_times"""
...
def test_api_get_markers(ridesystems_api):
    """Test for Ridesystems API method get_markers"""
...
def test_api_get_ridership_data(ridesystems_api):
    """Test for Ridesystems API method get_ridership_data"""
    ret = ridesystems_api.get_ridership_data(date.today(), date.today())
    assert isinstance(ret, list)
    assert len(ret) >= 0  # Ridesystems doesn't have ridership data
